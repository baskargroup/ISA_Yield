...
#SBATCH --job-name="M4_Corn_stat_seed2048"
#SBATCH --mail-user=bgekim@iastate.edu   # email address
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output="M4_Corn_stat_seed2048_%j.out" # job standard output file (%j replaced by job id)
#SBATCH --error="M4_Corn_stat_seed2048_%j.err" # job standard error file (%j replaced by job id)
...
seed=2048
for yaml_file in conf_M4_stat/s12cdw_*_corn.yaml; do
...
echo "Job finished for M4_corn_stat seed $seed"

...
#SBATCH --job-name="M4_Corn_stat_seed234"
#SBATCH --mail-user=bgekim@iastate.edu   # email address
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output="M4_Corn_stat_seed234_%j.out" # job standard output file (%j replaced by job id)
#SBATCH --error="M4_Corn_stat_seed234_%j.err" # job standard error file (%j replaced by job id)

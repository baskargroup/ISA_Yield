...
#SBATCH --job-name="M4_Soybean_stat_seed567"
#SBATCH --mail-user=bgekim@iastate.edu   # email address
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output="M4_Soybean_stat_seed567_%j.out" # job standard output file (%j replaced by job id)
#SBATCH --error="M4_Soybean_stat_seed567_%j.err" # job standard error file (%j replaced by job id)
...
echo "Job is starting on `hostname` for M4_Soybean_stat seed 567"

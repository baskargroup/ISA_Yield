...
#SBATCH --job-name="M3_corn_delta"
#SBATCH --mail-user=aapowadi@iastate.edu   # email address
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output="M3_corn_delta%j.out" # job standard output file (%j replaced by job id)
#SBATCH --error="M3_corn_delta%j.err" # job standard error file (%j replaced by job id)
...
echo "Job is starting on `hostname` for M3_corn_delta"

for yaml_file in conf_M3_stat_delta/*_corn.yaml; do
...
echo "Job finished for M3_corn_delta"
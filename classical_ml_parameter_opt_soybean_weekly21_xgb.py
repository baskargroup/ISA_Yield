...
WEEK_NAME = 'processed_data_weekly_21'
...
xgb_param_results.to_csv(f"classical_ml_param_opt_soybean_{_code}_weekly21_xgb_all_params.csv", index=False)
...
df_results.to_csv(f"classical_ml_param_opt_soybean_{_code}_weekly21_xgb.csv", index=False)

...
def merge_files(list_of_files, crs, band_name, output_dir, file_id):
    ...
    for folder in tqdm(base_dirs, desc="Processing folders"):
        ...
        for band in bands:
            ...
            for file in band_files:
                file_id = os.path.basename(file).split('_')[-2]
            ...
            for file_id, utm_dict in id_groups.items():
                try:
                    ...
                    if wgs84_files:
                        ...
                        merge_files(wgs84_files, "4326", band, f"./final_s2_v3/{_folder}", file_id)

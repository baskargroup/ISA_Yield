...
if __name__ == "__main__":
    ...
    # Set up logger
    logger = setup_logger("./logs/IL_s2_merge_local.log")

    # Base directory
    base_dir_pattern = "/work/mech-ai-scratch/rtali/gis-sentinel2-IL/IL-sentinel2-fromANVIL/IL_sentinel2/*"
    ...
    base_dirs = [dir for dir in base_dirs if datetime.strptime(
        dir.split("/")[-1], "%Y-%m-%d") >= start]

    # Output directory
    os.makedirs("./process_s2_IL", exist_ok=True)
    output_dir = "./process_s2_IL"
    ...
    for folder in tqdm(base_dirs, desc="Processing folders"):
        ...
        for band in bands:
            ...
            if not band_files:
                ...
                os.makedirs(f"./final_s2_v3_IL/{_folder}", exist_ok=True)

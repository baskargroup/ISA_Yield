...
for biweek_folder in all_biweek_folders:
    ...
    xgb_param_results.to_csv(f"xgb_param_opt_soybean_{_code}_{week_name}_all_params.csv", index=False)
    ...
    plsr_param_results.to_csv(f"plsr_param_opt_soybean_{_code}_{week_name}_all_params.csv", index=False)
...
print(df_results)
df_results.to_csv(f"classical_ml_param_opt_soybean_{_code}.csv", index=False)

df_file = pd.DataFrame(file_level_results)
df_file.to_csv(f"classical_ml_param_opt_field_level_soybean_{_code}.csv", index=False)

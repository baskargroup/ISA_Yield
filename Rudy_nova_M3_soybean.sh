...
#SBATCH --job-name="Soy_M3"
#SBATCH --mail-user=aapowadi@iastate.edu   # email address
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output="soy_M3%j.out" # job standard output file (%j replaced by job id)
#SBATCH --error="soy_M3%j.err" # job standard error file (%j replaced by job id)

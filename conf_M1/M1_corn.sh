...
#SBATCH --job-name="M1_corn_terramind_1e_5"
#SBATCH --mail-user=bgekim@iastate.edu   # email address
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output="M1_corn_terramind_1e_5%j.out" # job standard output file (%j replaced by job id)
#SBATCH --error="M1_corn_terramind_1e_5%j.err" # job standard error file (%j replaced by job id)

...
#SBATCH --job-name="corn_M4_2_weekly"
#SBATCH --mail-user=bgekim@iastate.edu
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output="corn_M4_2_%j.out"
#SBATCH --error="corn_M4_2_%j.err"
...
# Config files to run
# CONFIGS=(
#     "conf_M4/M4_2/delta_s12d_6_corn.yaml"
#     "conf_M4/M4_2/delta_s12d_8_corn.yaml"
#     "conf_M4/M4_2/delta_s12d_10_corn.yaml"
# )
CONFIGS=(
    "conf_M4/M4_2/delta_s12wdsc_6_corn.yaml"
    "conf_M4/M4_2/delta_s12wdsc_8_corn.yaml"
    "conf_M4/M4_2/delta_s12wdsc_10_corn.yaml"
)

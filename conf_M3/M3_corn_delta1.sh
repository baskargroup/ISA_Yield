...
#SBATCH --job-name="M3_corn_delta1"
#SBATCH --mail-user=aapowadi@iastate.edu   # email address
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output="M3_corn_delta1%j.out" # job standard output file (%j replaced by job id)
#SBATCH --error="M3_corn_delta1%j.err" # job standard error file (%j replaced by job id)
...
echo "Job is starting on `hostname` for M3_corn_delta1"

for yaml_file in conf_M3_delta1/*_corn.yaml; do
...
echo "Job finished for M3_corn_delta1"
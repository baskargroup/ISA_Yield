...
#SBATCH --job-name="M3_Soybean_stat_seed1024"
#SBATCH --mail-user=aapowadi@iastate.edu   # email address
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output="M3_Soybean_stat_seed1024_%j.out" # job standard output file (%j replaced by job id)
#SBATCH --error="M3_Soybean_stat_seed1024_%j.err" # job standard error file (%j replaced by job id)
...
echo "Job is starting on `hostname` for M3_Soybean_stat seed 1024"

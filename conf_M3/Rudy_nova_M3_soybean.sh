...
#SBATCH --job-name="M3_Soybean"
#SBATCH --mail-user=aapowadi@iastate.edu   # email address
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output="M3_Soybean%j.out" # job standard output file (%j replaced by job id)
#SBATCH --error="M3_Soybean%j.err" # job standard error file (%j replaced by job id)

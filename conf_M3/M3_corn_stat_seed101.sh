...
#SBATCH --job-name="M3_Corn_stat_seed101"
#SBATCH --mail-user=aapowadi@iastate.edu   # email address
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output="M3_Corn_stat_seed101_%j.out" # job standard output file (%j replaced by job id)
#SBATCH --error="M3_Corn_stat_seed101_%j.err" # job standard error file (%j replaced by job id)

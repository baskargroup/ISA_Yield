...
WEEK_NAME = 'processed_data_fs_16_18_1'
...
NORM_STATS = {
    ...
    "SOIL": {
        "mean": np.array([0.812, 0.787, 0.741, 20128.930, 21412.781, 253.445, 87.680, 182.086, 264.623, 335.160]),
        "std": np.array([0.064, 0.071, 0.079, 6099.627, 6499.918, 44.726, 4.492, 15.991, 28.075, 41.569]),
    },
}

...
WEEK_NAME = 'processed_data_weekly_19'
...
param_results.to_csv(f"classical_ml_param_opt_corn_{_code}_weekly19_plsr_all_params.csv", index=False)
...
df_results.to_csv(f"classical_ml_param_opt_corn_{_code}_weekly19_plsr.csv", index=False)
